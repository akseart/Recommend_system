...
def create_app():
    ...
    def createBookPage(book_id):
        ...
        recommend = [configure_and_run.book[x] for x in configure_and_run.book.get_recommend(book_id)]
        return render_template('books.html', books=book, recommend=recommend)
